      ...
      <article>
        ...
        <ArticleContent>
          ...
          <section id="prompt-examples" className="mb-12">
            ...
            >
              以下のドキュメントアウトラインに従って、各セクションの内容をCanvas上で詳細に記述してください。特に「導入」と「結論」は読者の興味を引くように、具体的な事例を交えて展開してください。
            </PromptBlock>
            
            <PromptBlock
              title="多角的レビュープロンプト"
            >
              このドキュメントの第3章について、専門用語を一般向けに噛み砕きつつ、具体例を2つ追加してCanvas上で更新してください。また、法務担当者の視点から、潜在的なリスクや法的表現の修正点を指摘してください。
            </PromptBlock>
            
            <PromptBlock
              title="バージョン管理と差分修正"
            >
              前回のCanvasの状態から、今回の修正で変更された箇所をハイライトし、その変更がドキュメント全体に与える影響について簡潔に説明してください。特に、第2章のデータ解釈の変更点に焦点を当ててください。
            </PromptBlock>
          </section>
