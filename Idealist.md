...
*   [最新の個別ネタ](docs/ideas/)
    ...
    *   [2026-04-06: 書くのも直すのもAIと一緒！ChatGPT「Canvas（キャンバス）」で文章作成をラクにするプロンプト術](docs/ideas/idea-20260406-chatgpt-canvas-beginner.md) - *新規追加*
    *   [2026-04-06: チャットの回答をそのまま「資料」に！Microsoft Copilot「Pages（ページ）」超入門](docs/ideas/idea-20260406-copilot-pages-beginner.md) - *新規追加*
