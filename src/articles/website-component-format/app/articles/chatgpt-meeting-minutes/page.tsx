...
// プロンプトデータ
const prompts = {
  prompt1: `以下の会議メモを元に、ビジネス文書として適切な議事録を作成してください。
...
以上`,
  ...
  prompt2: `以下は会議の音声を文字起こししたテキストです。
...
以上`,
  ...
  prompt3: `以下の議事録から、アクションアイテム（タスク）を抽出してリスト化してください。
...
以上`,
  ...
  prompt4: `以下の議事録を、要点のみを抜粋した要約版に変換してください。
